...
- Normal User :
  ...
  - [ ] Lihat Detail suatu `Queue`.
- Admin
  - [ ] CRUD `Queue`.
  - [ ] Menjalankan suatu `Queue`.
  - [ ] Memanggil user yang mendaftar suatu `Queue`, pemanggilan bisa tidak berurutan (misal, pemanggilannya: no 1, 2, 5, 8, 3, 9, 6, ...).
  - [ ] Menyelesaikan suatu `Queue` (jika semua user telah dipanggil).
