    ...
    <div class="container">
      ...
      <aside class="sidebar">
        ...
        <nav class="layer-menu">
          <ul class="menu">
            <li><a href="index.php" class="btn light">Ambil Antrean</a></li>
            <li>
              <a href="antrian-berlangsung.php" class="btn dark"
        ...
        <div class="cards">
          <div class="card">
            ...
            <div class="card-info">
              <p>5 Juli 2045</p>
              <p>Gelombang 1</p>
              <span>Kuota : 100 cpd</span>
            </div>
          </div>

          <div class="card">
            <div class="card-number">No. 000</div>
            <div class="card-info">
              <p>6 Juli 2045</p>
              <p>Gelombang 1</p>
              <span>Kuota : 100 cpd</span>
